...
public class AttachGameObjectsToParticles : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            tempGameObject = Instantiate(m_Prefab, m_ParticleSystem.transform);
            m_Instances.Add(tempGameObject);
            tempGameObject.transform.localScale *= m_Particles[m_Instances.Count-1].GetCurrentSize(m_ParticleSystem);
        }
